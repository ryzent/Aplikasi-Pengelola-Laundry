        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light nab">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    <img src="{{asset('assets/img/stisla-fill.svg')}}" alt="" width="30" height="24"
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#cek_invoices">Cek Status</a>
                        </li>
                    </ul>
                    @if (Route::has('login'))
                    <div class="d-flex align-content-end">
                        ...
                        @auth
                        <a class="nav-link btn btn-outline-success btn-sm" href="{{ url('/home') }}">Home</a>
                        @else
            ...
            <section class="section">
                <div class="p-5 mb-4 bg-light rounded-3">
                    <div class="container-fluid py-5">
                        ...
                        <p class="col-md-8 fs-4">Aplikasi Manajemen Laundry dengan Laravel </p>
                        <button class="btn btn-primary btn-lg text-white" type="button">Kuy!</button>
                    </div>
                </div>
                ...
                <div class="container px-4 py-5" id="icon-grid">
                    ...
                    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
                      <div class="col d-flex align-items-start">
                        ...
                        <div>
                          <h4 class="fw-bold mb-0">Entri Transaksi</h4>
                          <p>Melakukan entri transaksi dengan mudah dan cepat</p>
                        </div>
                      </div>
                      <div class="col d-flex align-items-start">
                      ...
                      <div class="col d-flex align-items-start">
                        ...
                        <div>
                          ...
                          <p>Cetak dan tampilkan laporan berdasarkan bulan dan tahun hinggan cabang toko</p>
                        </div>
                      </div>
                      <div class="col d-flex align-items-start">
                ...
                <div class="px-4 py-5 my-5 text-center">
                    <form action="/get" method="post">
                        ...
                        <h1 class="display-5 fw-bold">Cek status laundry mu!</h1>
                        <div class="form-group col-6 mx-auto">
                            <input type="text" class="form-control" name="cek_invoice" id="cek_invoice" required>
                            <div class="invalid-feedback">
                                Harap isi kode invoice
                            </div>
                        </div>
                        <div class="col-lg-6 mx-auto my-5" id="cek_invoices">
                            <p class="lead mb-4">Kamu bisa melakukan pengecekan status cucian laundry kamu yang terdapat
                                di laundry kami disini.</p>
                            <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                                <button type="submit" class="btn btn-primary btn-lg px-4 gap-3 text-white">Tampilkan</button>
                            </div>
                        </div>
                    </form>
                    @isset($antrian)
                    @if ($antrian[0]->id_status == 1)
                    <div class="px-4 py-5 my-5 text-center" id="hasil">
                        <lottie-player class="mx-auto" src="{{asset('lotie/cart.json')}}" background="transparent"  speed="1"  style="width: 300px; height: 300px;" loop autoplay></lottie-player>
                        <h3 class="display-6 fw-bold">Cucian kamu dalam proses antrian.</h3>
                        <div class="col-lg-6 mx-auto">
                            <p class="lead mb-4">Harap sabar ya, kami akan memproses cucian kamu secepatnya.</p>

                        </div>
                    </div>
                    @elseif ($antrian[0]->id_status == 2)
                    <div class="px-4 py-5 my-5 text-center" id="hasil">
                        {{-- <img class="d-block mx-auto mb-4" src="#" alt="" width="72" height="57">
                         --}}

                             <lottie-player class="mx-auto" src="{{asset('lotie/laundry-progress.json')}}" background="transparent"  speed="1"  style="width: 300px; height: 300px;" loop autoplay></lottie-player>
                        <h3 class="display-6 fw-bold">Cucian kamu sedang kami proses.</h3>
                        <div class="col-lg-6 mx-auto">
                            <p class="lead mb-4">Harap sabar ya, kami sedang memproses cucian kamu secepatnya.</p>

                        </div>
                    </div>
                    @elseif ($antrian[0]->id_status == 3)
                    <div class="px-4 py-5 my-5 text-center" id="hasil">
                        <lottie-player class="mx-auto" src="{{asset('lotie/done.json')}}" background="transparent"  speed="1"  style="width: 300px; height: 300px;" loop autoplay></lottie-player>
                        <h3 class="display-6 fw-bold">Cucian kamu sudah selesai kami proses.</h3>
                        <div class="col-lg-6 mx-auto">
                            <p class="lead mb-4">Yuk ambil cucian kamu, jangan lupa membawa bukti transaksi ya.</p>
        ...
        <footer class="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
            <div class="col">
                <a href="/" class="d-flex align-items-center  link-dark text-decoration-none">
                    <svg xmlns="http://www.w3.org/2000/svg" width="150" height="56" viewBox="0 0 150 10">
                        <text id="ryzntxscape." transform="translate(0 20)" fill="#535353" font-size="20"
                            font-family="Poppins-SemiBoldItalic, Poppins" font-weight="600" font-style="italic">
                            <tspan x="0" y="0">ryzntxscape.</tspan>
                        </text>
                    </svg>
                </a>
                <span class="text-muted">ryzntxscape owned by Atha Nabil</span>
            </div>

    ...
    <section class="section" style="margin-top: 0px">
        ...
        <div class="row">
            <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                    <form action="{{ route('manajemen_pegawai.update', $user->id)}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="role" value="{{ $user->role ?? old('role') }}">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="id_outlet" value="{{ $user->id_outlet ?? old('id_outlet') }}">
                                    @foreach ($toko as $tk)
